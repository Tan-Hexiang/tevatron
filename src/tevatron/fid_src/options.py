...
class Options():
    ...
    def add_reranker_options(self):
        self.parser.add_argument('--init_from_huggingface', action='store_true', help='init the weight from nboost/pt-bert-base-uncased-msmarco')
    
    def add_experiment_options(self):
        self.parser.add_argument('--generate_LOOP_score', action='store_true', help='generate loop score')
        self.parser.add_argument('--generate_PDist_score', action='store_true', help='generate pdist score')
        self.parser.add_argument('--score_key', type=str, default='PDist_score')
        self.parser.add_argument('--result_filename', type=str, default='train')
        self.parser.add_argument('--sort_by_score', action='store_true')
        self.parser.add_argument("--passages_source_path",type=str)
    ...
    def add_rerank_parser(self):
        '''
        also use: --model_path --per_gpu_batch_size
        '''
        self.parser.add_argument('--retrieved_data_path',type=str)
        self.parser.add_argument('--save_path',type=str)
        self.parser.add_argument('--n_context',type=int,default=100,help='input n_context passages each question')
        self.parser.add_argument('--k',type=int,default=5,help='output top k passages')
